...
【本段开场继承】
第一段写“无，建立初始站位”。第二段及以后必须从上一段【本段结尾状态锁】继承：角色位置、朝向、手部/脚步状态、道具状态、视线方向、声音余韵、环境状态；不得重新开一个无关画面。
...
【本段结尾状态锁】
必须写清本段最后一帧的可接状态：谁在什么位置、朝向谁或看向哪里、手里拿着什么、道具处于什么状态、身体动作停在什么余势上、声音/光线/环境有什么延续、下一段第一镜应该从哪个动作/视线/声音/道具/空间遮挡接起。
...
17. 如果剧情确实换场，必须用遮挡转场、声音先入、动作出画、门/车/楼梯/人群等合理过渡，并在【本段结尾状态锁】和下一段【本段开场继承】里对应。
18. 以上逐段剧情分镜硬规则优先级最高；若与参考模板中“上一组结尾/下一组开头/角色资产/场景资产/物品资产”或固定转场规则冲突，以逐段剧情分镜硬规则为准。`;
