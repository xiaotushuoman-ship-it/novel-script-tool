...
【本段开场继承】
第一段写“无，建立初始站位”。第二段及以后必须从上一段【本段结尾状态锁】继承：角色位置、朝向、手部/脚步状态、道具状态、视线方向、声音余韵、环境状态和上一段最后一镜景别；下一段开场景别必须继承上一段最后一镜景别或使用相邻景别过渡，不得重新开一个无关画面。
...
6. 输出必须按“15S段落单元1、15S段落单元2、15S段落单元3……”分组；每组内部单独写【视觉基调】【色彩与影调】【光源与照明】【画面情绪】【本段开场继承】【主体和空间关系】【人物互动关系表】【画面内容】【本段结尾状态锁】。
...
20. 以上逐段剧情分镜硬规则优先级最高；若与参考模板中“上一组结尾/下一组开头/角色资产/场景资产/物品资产”或固定转场规则冲突，以逐段剧情分镜硬规则为准。`;
