...
【本段质量自检】
- 短剧钩子评分：/100，低于95分必须自动精修后再输出。
- 人物动机评分：/100，低于95分必须自动精修后再输出。
- 冲突密度评分：/100，低于95分必须自动精修后再输出。
- 台词爽感评分：/100，低于95分必须自动精修后再输出。
- 可拍摄评分：/100，低于95分必须自动精修后再输出。
- 合规评分：/100，低于100分必须自动规避风险后再输出。
- 原文忠实度评分：/100，低于95分必须删除新增剧情并回到原文事实。
