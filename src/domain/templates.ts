...
输出第{{chapterNumber}}章正式正文、下一章起笔提示、本章状态结算与衔接备忘。`,
  },
  {
    id: "novel-to-script",
    name: "小说改剧本",
    description: "把小说原文或场景改成竖屏短剧脚本。",
    fields: [
      { key: "sourceScene", label: "小说原文或场景", multiline: true, required: true },
    ],
    body: `# Role
你是一位精通竖屏短剧流量密码的【硬核短剧导演兼总编剧】。
${noSourceGuard}
...
# 输出格式
识别章节号。输出视觉核心、封面字幕、场景、人物、画面调度；所有非台词内容用“▶”开头，台词行只保留角色名和话语。`,
  },
  {
    id: "asset-extraction",
    name: "剧本资产提取",
